...
import Swal__default, { SweetAlertOptions, SweetAlertResult, SweetAlertUpdatableParameters, SweetAlertArrayOptions } from 'sweetalert2';
...
declare class SwalComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
     ...
     *     }
     */
    readonly dismiss: EventEmitter<Swal__default.DismissReason | undefined>;
    /**
...
interface SwalPortalTarget {
    ...
    element(swal: typeof Swal__default): HTMLElement | null;
}
/**
...
type SwalModule = typeof Swal__default | typeof Swal;
...
declare class SweetAlert2LoaderService {
    ...
    get swal(): Promise<typeof Swal__default>;
